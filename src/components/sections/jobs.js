...
class Jobs extends React.Component {
    render() {
        return(
<div >
<h2 style={{color:'orange', paddingLeft:'30%'}}>Past Experience</h2>
    <h3 style={{color:'black', paddingLeft:'30%'}}>Merzier Process Group (MPG), Consultant</h3>
    <h5 style={{color:'black', paddingLeft:'30%'}}>Washington D.C. Metro Area - 07/2019 - 04/2021</h5>
