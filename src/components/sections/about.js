...
<div id='about'>
    ...
    <h2 style={{color:'orange', paddingLeft:'30%'}}>About Me</h2>
        ...
        Fast-forward to today, and after a couple of years of working in IT and closely with developers on my teams, I decided to rekindle my interests dive head first into the world of software engineering. I'm always focused on learning new technologies and jumping deeper into this new passion of mine.<br/><br/>
